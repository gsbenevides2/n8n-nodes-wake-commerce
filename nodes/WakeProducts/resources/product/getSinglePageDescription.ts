...
const showOnlyForProductGetSinglePage = {
	operation: ['getSinglePageProducts'],
	resource: ['product'],
};

export const productGetSinglePageDescription: INodeProperties[] = [
	{
		displayName: 'Limit',
		name: 'limit',
		type: 'number',
		displayOptions: {
			show: showOnlyForProductGetSinglePage,
		},
		typeOptions: {
			minValue: 1,
			maxValue: 50,
